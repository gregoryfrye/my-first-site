...
export function Nav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-10 bg-canvas/85 px-gutter py-nav backdrop-blur-sm">
      <div className="mx-auto grid max-w-wide grid-cols-3 items-center gap-gutter">
        <Link
          href="/"
