  ...
  return (
    <>
      <nav className="fixed inset-x-0 top-0 z-10 bg-canvas/85 px-gutter py-nav text-center backdrop-blur-sm">
        <span className="font-serif text-body text-ink">Greg Frye</span>
      </nav>

      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-20 px-gutter pt-40 pb-20">
        <header className="text-center">
          <h1 className="font-serif text-heading tracking-tight text-ink">
        ...
        {featured && (
          <Link
            ...
            className="block border border-border p-8 text-center no-underline transition-colors hover:border-ink"
          >
      ...
      <footer className="px-gutter py-gutter text-center">
        <a
          href="mailto:gregoryfrye@gmail.com"
          className="font-serif text-body text-ink no-underline"
        >
